...
> 此项目是基于 wx-mini 项目,做的修改. 本项目用于公司生产环境的开发.如果有好的idea/issue,希望提issue,我将会尽快解决,也将会帮助公司完善项目.
[源项目](https://github.com/webpersonalserver/wx-mini)

**升级内容**
1. 从babel6 升级到了 babael7;
